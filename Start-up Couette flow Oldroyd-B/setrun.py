...
#------------------------------
    ...
    probdata.add_param('E',  1.0,  'elasticity number')
    probdata.add_param('Ma',    0.5,  'viscoelastic mach number')
    
    probdata.add_param('rho',  1.0,  'density of medium')
    probdata.add_param('K',    4.0,  'bulk modulus')
    probdata.add_param('beta', 0.1, 'viscosity ratio')
...
#        clawdata.tfinal = 0.800000
        clawdata.num_output_times = 400
        clawdata.tfinal = 10.000000
